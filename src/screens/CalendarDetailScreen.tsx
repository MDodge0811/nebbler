...
export function CalendarDetailScreen({ route }: RootStackScreenProps<'CalendarDetail'>) {
  return (
    <Box className={containerStyle({})}>
      <Text className={titleStyle({})}>Calendar Detail</Text>
      <Text className={subtitleStyle({})}>{route.params.calendarId}</Text>
    </Box>
  );
}
