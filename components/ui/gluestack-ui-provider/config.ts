...
export const config = {
  light: vars({
    ...
    '--color-brand-surface-subtle': '250 250 250' /* #FAFAFA */,
    '--color-brand-divider': '240 240 243' /* #F0F0F3 */,
    '--color-brand-handle': '209 213 219' /* #D1D5DB */,
    '--color-brand-danger-border': '255 212 212' /* #FFD4D4 */,
    '--color-brand-danger-text': '204 68 68' /* #CC4444 */,
    '--color-brand-pending-bg': '255 246 224' /* #FFF6E0 */,
    '--color-brand-pending-border': '244 213 141' /* #F4D58D */,
    '--color-brand-pending-dot': '255 179 71' /* #FFB347 */,
    '--color-brand-pending-text': '160 115 0' /* #A07300 */,
    '--color-brand-success-text': '10 143 79' /* #0A8F4F */,
    '--color-brand-role-admin-bg': '237 233 254' /* #EDE9FE */,
    '--color-brand-role-admin-text': '124 58 237' /* #7C3AED */,
    '--color-brand-role-admin-border': '221 214 254' /* #DDD6FE */,
    '--color-brand-type-social-bg': '232 247 252' /* #E8F7FC */,
    '--color-brand-type-social-text': '0 144 176' /* #0090B0 */,
    '--color-brand-type-public-bg': '240 235 255' /* #F0EBFF */,
    '--color-brand-type-public-text': '124 92 196' /* #7C5CC4 */,
